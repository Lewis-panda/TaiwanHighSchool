...
\usepackage{xcolor}
\usepackage{graphicx}
\graphicspath{{figs/}}          % 圖（ASCII 檔名）放在 講義/figs/

% ---- 中文字型（本機 Linux：思源宋體／黑體 Noto CJK TC）----
\usepackage{xeCJK}
\setCJKmainfont{Noto Serif CJK TC}   % 內文：宋體
\setCJKsansfont{Noto Sans CJK TC}    % 標題/強調：黑體
