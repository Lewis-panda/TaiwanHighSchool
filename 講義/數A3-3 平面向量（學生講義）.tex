...
\fig{d33-dot-product}{0.62}{圖 3-2：內積的幾何意義。$\vec b$ 在 $\vec a$ 方向上的投影長為 $|\vec b|\cos\theta$，乘上 $|\vec a|$ 即得內積 $\vec a\cdot\vec b=|\vec a||\vec b|\cos\theta$。}
...
\fig{d33-projection}{0.60}{圖 3-3：$\vec b$ 在 $\vec a$ 上的正射影。從 $\vec b$ 的尖端對 $\vec a$ 所在直線作垂線，落點與原點之間沿 $\vec a$ 方向的那支紅色向量，即正射影向量 $\left(\dfrac{\vec a\cdot\vec b}{|\vec a|^2}\right)\vec a$。}
...
\fig{d33-determinant-area}{0.58}{圖 3-4：以 $\vec a=(x_1,y_1)$、$\vec b=(x_2,y_2)$ 為鄰邊的平行四邊形，其面積等於二階行列式的絕對值 $|x_1y_2-x_2y_1|$。}
