...
\fig{si4-contact-push}{0.82}{圖 4-6：接觸推擠型連接體。上排為整體情境：外力 $F$ 推後塊 $m_1$，$m_1$ 再推前塊 $m_2$，兩塊以同一加速度 $a$ 前進。下排為前塊 $m_2$ 的隔離自由體圖：水平方向只有 $m_1$ 對它的接觸力 $F_{1\to 2}$，故 $F_{1\to 2}=m_2\,a$，一般小於外力 $F$。}
